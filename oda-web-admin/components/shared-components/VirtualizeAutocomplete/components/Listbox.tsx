...
import { useVirtualizeAutocompleteContext } from '../useVirtualizeAutocompleteContext';
...
const Listbox = forwardRef<HTMLDivElement, HTMLAttributes<HTMLElement>>(
  ({ children, ...rest }, ref) => {
    ...
    const { isLoadingMore, isFetching, onFetchMore } =
      useVirtualizeAutocompleteContext();
    ...
    return (
      <BoxListStyled className="Listbox" ref={ref} onScroll={handleScroll}>
