import { useGetCompanyDistrictListQuery } from '@/apis';
...
export const AreaGroup = (props: IAreaGroupProps) => {
  ...
  const { data: resp } = useGetCompanyDistrictListQuery(deliveryArea.city.id, {
  ...
  const districtList = useMemo(() => {
    ...
    deliveryArea.district_ids.forEach((districtId: number) => {
