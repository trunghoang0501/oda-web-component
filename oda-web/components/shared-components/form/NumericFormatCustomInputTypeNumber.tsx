...
export type INumericFormatCustomInputTypeNumberProps = Omit<
  NumericFormatProps,
 ...
 */
const NumericFormatCustomInputTypeNumber = forwardRef<
  HTMLInputElement,
  INumericFormatCustomInputTypeNumberProps
...
export default NumericFormatCustomInputTypeNumber;
