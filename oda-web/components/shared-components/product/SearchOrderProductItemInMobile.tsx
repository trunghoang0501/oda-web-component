...
import { StepInputOrderProduct } from '@/components/shared-components/form/StepNumberInput/StepInputOrderProduct';
import {
...
export const SearchOrderProductItemInMobile = <T extends IProductCommon>(
  ...
  return (
    ...
    >
      ...
      >
        <Box display="flex">
          <Box onClick={onClick} display="flex" flexDirection="column" pt={1.5}>
            <Image
          ...
          >
            ...
            >
              ...
              <Box>
                <StepInputOrderProduct
                  value={quantity}
                  highlight={false}
                  onChange={onQuantityChange}
                  onBlur={onQuantityBlur}
                  minValue={DEFAULT_MIN_QUANTITY}
