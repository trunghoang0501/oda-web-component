...
import { SCREEN_WIDTH_MOBILE } from '@/utils/constants';
...
class SingleOtpInput extends PureComponent {
  ...
  componentDidMount() {
    ...
    this.setState({ isMobile: window.innerWidth <= SCREEN_WIDTH_MOBILE });
  }
...
class OtpInput extends Component {
  ...
  handleOtpChange = (otp) => {
    ...
    this.setState({ activeInput: otp.filter((el) => el !== '').length });
    onChange(otpValue);
  };
